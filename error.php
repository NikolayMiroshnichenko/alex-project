...
<html lang="en">
   <head>
      ...
      <meta charset=UTF-8>
      <title>4-х недельный практический онлайн курс Messenger Marketing для начинающих - страница не успешной оплаты</title>
      ...
      <meta property="og:url" content="https://protargeting.team/messenger_marketing/">
   ...
   <body class="max-container">
      <section class="main-tanks-wrapper">
         <header class="header container">
            <a href="index.php" class="logo">Messenger Marketing</a>
         ...
         <div class="main-form container">
            <div class="main-form-poligon thanks-poligon"></div>
            <div class="main-form-table-thanks"></div>
            <div class="main-form-frame"></div>
            <div class="step">
               <div class="step-item">Шаг 1</div>
               <div class="step-item step-item-activ">Шаг 2</div>
            </div>
            <div class="main-content">
               <h1 class="main-conent__title">
                  Ваша оплата 
                  <div class="tanks-title_no">не прошла...</div>
               </h1>
               <p class="main-conent__des">Ожидайте звонок нашего менеджера</p>
            </div>
         </div>
      </section>
      <footer class="footer">
